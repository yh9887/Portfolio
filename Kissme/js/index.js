...
$(function () {
  ...
  $('#fullpage').fullpage({
    ...
    afterLoad: function (anchorsLink, index) {
      ...
      if ( index == 2) {
        ham($('.main_txt1 h1, .main_txt1 h1 span'), 'translateY(0px) ', '1', '80')
        ham($('.brand_logo '), 'translateY(0px)', '1', '80');
        ham($('.brand_border'), 'scale(1)', '1','80');
        ham($('.brand_txt1'), 'translateY(0px)', '1','80');
        ham($('.brand_txt2'), 'translateY(0px)', '1','80');
      }
      // else{
